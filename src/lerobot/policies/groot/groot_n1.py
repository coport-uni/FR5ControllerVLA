...
class GR00TN15Config(PretrainedConfig):
    ...
    # `default=None` keeps these fields legal on Python 3.12's stricter
    # dataclass ordering check (a non-default field cannot follow a default
    # one). Values are still assigned in the custom `__init__` below.
