...
# --pretrained_name_or_path=coport-uni/FR5_pick_red_colored_marker_to_box_smolvla_adv_model
...
python3 -m lerobot.async_inference.robot_client \
    ...
    --pretrained_name_or_path=coport-uni/FR5_pick_red_colored_marker_to_box_smolvla_model22 \
    --policy_type=smolvla \
    --policy_device=cuda \
